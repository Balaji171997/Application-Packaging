...
@{
    ...
    FunctionsToExport = @(        
        ...
        'Set-PathEnvironmentVariable',
        'Remove-PathEnvironmentVariable',
        'Expand-ZipFile',
        'Add-EntryToZipFile',
        'Expand-SingleEntry',
        'Remove-EntryFromZipFile',
        'Compress-ZipFile',
        'Get-SCCMSiteCode',
        'Get-WMIInstance',
        'Get-WMINamespace',
        ...
        'Remove-BrandingREG',
        'Remove-Branding',
        'Expand-SoftwareBrandingWMIClass',
        'Set-Reboot',
        'Get-WindowsDriverOnline',
        'Add-WindowsDriverOnline',
        'Remove-WindowsDriverOnline',
        'Add-Font',
        'AddType-Font',
        'Remove-Font',
        'Add-UGPermission',
