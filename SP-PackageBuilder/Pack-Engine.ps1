...
$engineFiles = @('Core.ps1','Theme.ps1','Predecessor.ps1','Build.ps1','Source.ps1','MstBuilder.ps1','BundledMsi.ps1',
                 'Snapshot.ps1','Screenshots.ps1','Assemble.ps1','Snippets.ps1','Sccm.ps1','Intune.ps1','PSADT_V3toV4_Mappings.ps1',
                 # SharePoint variant: MUST stay LAST. It captures the originals from Source.ps1 / Predecessor.ps1
                 # and overrides them; packed earlier it would capture nothing and silently run UNC-only.
                 'SharePoint.ps1')
