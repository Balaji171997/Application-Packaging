...
(function () {
    ...
    dashboard.controller("dashboardController", function ($scope, $sce) {
        ...
        async function LoadDataAsync() {
            ...
            $scope.strings = await callJsonParseMethodAsync("GetStrings");
            $scope.DTPStatusData = await callJsonParseMethodAsync("GetDeviceThreatStatusData");
            $scope.DTPComplianceData = await callJsonParseMethodAsync("GetDeviceThreatComplianceStatus");
            $scope.iOSDeviceData = await callJsonParseMethodAsync("GetIOSDeviceReportingStatus");
            $scope.topThreatsData = await callJsonParseMethodAsync("GetTopThreatsData");
            $scope.androidDeviceData = await callJsonParseMethodAsync("GetAndroidDeviceReportingStatus");
            ...
            $scope.createDonutChart("#DeviceThreatDonut", $scope.DTPStatusData, deviceThreatColorPattern, "right", function (evt) {
                adminUI.sendNewRequest("OnDeviceThreatChartClick", evt.name);
            });
            if ($scope.brightness < 125) {
                SetColorToAllTextInChart("#DeviceThreatDonut", $scope.theme.ForeGroundColor);
            }

            $scope.createDonutChart("#DTPComplianceDonut", $scope.DTPComplianceData, compliancePattern, "bottom", function (evt) {
                adminUI.sendNewRequest("OnDeviceComplianceChartClick", evt.name);
            });
            if ($scope.brightness < 125) {
                SetColorToAllTextInChart("#DTPComplianceDonut", $scope.theme.ForeGroundColor);
            }

            $scope.createGaugeChart("#iOSDevicesChart", $scope.iOSDeviceData,  function (evt) {
                adminUI.sendNewRequest("OnIOSDeviceChartClick");
            });
            if ($scope.brightness < 125) {
                SetColorToAllTextInChart("#iOSDevicesChart", $scope.theme.ForeGroundColor);
            }

            $scope.createGaugeChart("#AndroidDevicesChart", $scope.androidDeviceData, async function (evt) {
                await callMethodAsync("OnAndroidDeviceChartClick");
            });
            if ($scope.brightness < 125) {
                SetColorToAllTextInChart("#AndroidDevicesChart", $scope.theme.ForeGroundColor);
            }

            $scope.createHorizBarChart("#TopThreatsChart", $scope.topThreatsData);
            if ($scope.brightness < 125) {
                SetColorToAllTextInChart("#TopThreatsChart", $scope.theme.ForeGroundColor);
            }
        ...
        $scope.createHorizBarChart = async function (idToBindTo, columns) {
            c3.generate({
                bindto: idToBindTo,
                bar: {
                    width: 20
                ...
                data: {
                    ...
                    onclick: async function (evt) {
                        await callMethodAsync("OnTopThreatsChartClick", columns[0][evt.x + 1]);
                    }
                },
                axis: {
                    rotated: true,
...
// SIG // rKzatfponVmOn9LMQKSnQF/zulhrBAt1v2vZnpEBRzOg
...
// SIG // AYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCuGl/PkmOx94v5
// SIG // DvwQmTxcbufyvcFLHIff7idcd43aHTCBigYKKwYBBAGC
...
// SIG // BgkqhkiG9w0BAQEFAASCAQCShWAH/tO+0asTqQR0PEVR
// SIG // 3bhhWy+07ZcCwWVkHVsF/J5BVSW6lW2tScsvnB767zyv
// SIG // 3hYAIjD5Il5izeZ+j+pi+mObHxYYCeY29NSbwaUOPuHI
// SIG // XRZYZJPewFwjbRoJxkdPj303698rKWwDfg9Ts7CGgiUD
// SIG // ZvyGpEVlZpDAgoJRr5crCftmLuu10DzfF6b0VDtiVqmA
// SIG // afvOMmdKD01OER003bRJoe/eUhxlOEsbSpeNVJSXy14D
// SIG // DR9jPE82/HgfAbl9Dkkx6nwdr52svVgvsXJhF3oir0kS
// SIG // PlrSAgxqlTbinynPeJgTau+/b4j/ZewPRUILIHMRUSwH
// SIG // hQ2dVLazzAaToYIXrzCCF6sGCisGAQQBgjcDAwExgheb
...
// SIG // BAIBBQAEIE2PlYCqe0XMyt8+55nQch/cRMx9GWpIpOWU
// SIG // BdG4/e5JAgZo8n1NKecYEzIwMjUxMDIzMDI0NzMzLjQ1
...
// SIG // KoZIhvcNAQkEMSIEIC/WXn8UGNViOcIfWxf8ZHQOLuqz
// SIG // Lcz7dG2yUCtVSF5aMIH6BgsqhkiG9w0BCRACLzGB6jCB
...
// SIG // AzANBgkqhkiG9w0BAQsFAASCAgBJkBw9j47zHRBZ1QgV
// SIG // DZu4XxCrfn44YYMONM0q05Yck5WgaR3CknH7Vqx99mHd
// SIG // TDsZtUv7BuZQjQeqUIij9LTLrbafqb73Mj/1k1oTvkhU
// SIG // UR0kbsM00V7f6pzJLNgsupF6M+jwfbsWhkL8DQZQkmoI
// SIG // MrynNEI1BHTGy3VF/1SLGSa3IIsGHsD7eY0hIxy6AfBy
// SIG // gyUB38oDbySSDfJ1a6DwvRDPy2za316EgcH4EsEGZedM
// SIG // +iaWP4TOjWk2yXlNJ+53uqiTlbeGCyphl7Wp3Hu7Lyk6
// SIG // odjC0an5BLCg5Wdy26LYfxZRbql7Y4L/+UzkS1EaieiN
// SIG // Ys2coSMMwsZ0KTHultB/i89VgUm1iUZjw3udwER/ipfW
// SIG // uFrweS5LVUIsj3mBKYQMxIdL/Y8XcXFEsuTgAq92wLbf
// SIG // Y5uPHxpHPuPS4b3pA3u4B9NsBieub2lLxgNWbj1mEDAu
// SIG // L7byWX0511Ob37oGotkX2GR3gKC5doU1NOd22vTceP9S
// SIG // TFLloDqJ6K7+litvmQHhGc0rS3Z3X4/YUSIBj10+2WHT
// SIG // lO+H/uzrZbBy+Pk2PDiQhMt4ysBkQvmTTWGRusYvWQAA
// SIG // AUI2SaSX4dINtTlufaWSC2UevLuVT57ODfsxmBYHpzBU
// SIG // s9tzw1T1MlB1D5TOtRIRORjmK5EydRTMeCkjRcy0mx9a
// SIG // kw4qrA==
