...
@{
    Assets = @{
        ...
        Logo = '..\Assets\AppDeployToolkitLogoVWG.png'

        # Specify filename of the logo (for dark mode).
        LogoDark = '..\Assets\AppDeployToolkitLogoVWG.png'

        # Specify filename of the banner (Classic-only).
        Banner = '..\Assets\AppDeployToolkitBannerVWG.png'
    }
    ...
    Toolkit = @{
        ...
        CachePath = '$envCommonProgramFiles'
        ...
        TempPath = '$envCommonProgramFiles'
